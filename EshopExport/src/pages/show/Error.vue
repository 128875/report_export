<template>
    <div class="error-log">
        <div class="container">
            ...
            <el-table :data="data.records" class="table" ref="multipleTable" header-cell-class-name="table-header">
...
import {getErrorLog} from '@/api/http.js'
export default {
    name: 'EshopExportError',
    ...
    methods: {
        getData(){
            getErrorLog(this.query).then(res=>{
                if(res.code == 200){
                    this.data = res.data
        ...
        handleSearch(){
            ...
            this.$set(this.query, 'startTime', this.dateTime[0])
            this.$set(this.query, 'endTime', this.dateTime[1])
            this.getData()
        },
        handleReset(){
